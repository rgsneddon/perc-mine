...
const REQUIRED = [
  ...
  ['perc-mine Windows', 'https://github.com/rgsneddon/perc-mine/releases/download/v1.0.0/perc-mine-1.0.0-windows.zip'],
  ['perc-mine Linux', 'https://github.com/rgsneddon/perc-mine/releases/download/v1.0.0/perc-mine-1.0.0-linux.tar.gz'],
  ['perc-mine macOS', 'https://github.com/rgsneddon/perc-mine/releases/download/v1.0.0/perc-mine-1.0.0-macos.tar.gz'],
];
